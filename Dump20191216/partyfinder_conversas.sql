...
CREATE TABLE `conversas` (
  `idconversas` int(11) NOT NULL AUTO_INCREMENT,
  `partida_id` int(11) NOT NULL,
  `jogador_id` int(11) NOT NULL,
  PRIMARY KEY (`idconversas`),
  KEY `partida_id_idx` (`partida_id`),
  KEY `jogador_id_idx` (`jogador_id`),
  CONSTRAINT `jogador_id` FOREIGN KEY (`jogador_id`) REFERENCES `usuario` (`idUsuario`),
  CONSTRAINT `partida_id` FOREIGN KEY (`partida_id`) REFERENCES `partida` (`idpartida`)
